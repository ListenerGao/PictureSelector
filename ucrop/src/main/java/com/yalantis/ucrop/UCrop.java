...
public class UCrop {
    ...
    public static class Options {
        ...
        public static final String EXTRA_UCROP_WIDGET_CROP_IS_DARK_MODE = EXTRA_PREFIX + ".isDarkMode";
        public static final String EXTRA_UCROP_WIDGET_CROP_BACK_RES = EXTRA_PREFIX + ".backRes";
        public static final String EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT = EXTRA_PREFIX + ".completeText";
        public static final String EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT_SIZE = EXTRA_PREFIX + ".completeTextSize";
        public static final String EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT_COLOR = EXTRA_PREFIX + ".completeTextColor";
        public static final String EXTRA_UCROP_WIDGET_CROP_COMPLETE_BACKGROUND_STYLE = EXTRA_PREFIX + ".completeBackgroundStyle";
        ...
        public void isDarkMode(boolean isDark) {
            mOptionBundle.putBoolean(EXTRA_UCROP_WIDGET_CROP_IS_DARK_MODE, isDark);
        }

        public void setBackRes(@ColorRes int resId) {
            mOptionBundle.putInt(EXTRA_UCROP_WIDGET_CROP_BACK_RES, resId);
        }
        ...
        public void setCompleteText(String content) {
            mOptionBundle.putString(EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT, content);
        }
         ...
         * @param size
         */
        public void setCompleteTextSize(int size) {
            mOptionBundle.putInt(EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT_SIZE, size);
        }
         ...
         * @param resId
         */
        public void setCompleteTextColor(@ColorRes int resId) {
            mOptionBundle.putInt(EXTRA_UCROP_WIDGET_CROP_COMPLETE_TEXT_COLOR, resId);
        }
         ...
         * @param resId
         */
        public void setCompleteTextBackgroundStyle(@DrawableRes int resId) {
            mOptionBundle.putInt(EXTRA_UCROP_WIDGET_CROP_COMPLETE_BACKGROUND_STYLE, resId);
        }
