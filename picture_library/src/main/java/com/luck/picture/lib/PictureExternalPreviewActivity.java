    ...
    public void initPictureSelectorStyle() {
        if (PictureSelectionConfig.style != null) {
            if (PictureSelectionConfig.style.pictureContainerBackgroundColor != 0) {
                rootLayout.setBackgroundColor(PictureSelectionConfig.style.pictureContainerBackgroundColor);
            }
                            ...
                            PictureSelectionConfig.imageEngine.loadImage(contentView.getContext(), path,
                                    imageView, longImageView, new OnImageCompleteCallback() {
                                        ...
                                        public void onShowLoading() {
                                            Log.d("gys", "onShowLoading.....");
                                            showPleaseDialog();
                                        }

                                        @Override
                                        public void onHideLoading() {
                                            Log.d("gys", "onHideLoading.....");
                                            dismissDialog();
                                        }
                                    });
                        } else {
