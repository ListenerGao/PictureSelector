...
public class UCropManager {
    ...
    public static UCrop.Options basicOptions(Context context) {
        ...
        int backRes = 0;
        int completeTextSize = 0, completeTextColor = 0, completeTextBgStyle = 0;
        String completeText = "";
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            isDarkMode = PictureSelectionConfig.cropStyle.isDarkMode;
            completeText = PictureSelectionConfig.cropStyle.completeText;
            Log.d("gys", "completeText = " + completeText);
            completeTextSize = PictureSelectionConfig.cropStyle.completeTextSize;
            completeTextColor = PictureSelectionConfig.cropStyle.completeTextColor;
            completeTextBgStyle = PictureSelectionConfig.cropStyle.completeTextBackgroundStyle;
            ...
            if (PictureSelectionConfig.cropStyle.cropBackRes != 0) {
                backRes = PictureSelectionConfig.cropStyle.cropBackRes;
            }
        ...
        options.setBackRes(backRes);
        options.setCompleteText(completeText);
        options.setCompleteTextSize(completeTextSize);
        options.setCompleteTextColor(completeTextColor);
        options.setCompleteTextBackgroundStyle(completeTextBgStyle);
