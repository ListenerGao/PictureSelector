    ...
    public FolderPopWindow(Context context) {
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (config.isWeChatStyle) {
                this.drawableUp = ContextCompat.getDrawable(context, R.drawable.dark_picture_icon_wechat_up);
                this.drawableDown = ContextCompat.getDrawable(context, R.drawable.dark_picture_icon_wechat_down);
            } else {
                if (config.upResId != 0) {
