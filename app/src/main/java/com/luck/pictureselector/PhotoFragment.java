...
//                                .openExternalPreview(position, selectList);
                        ...
                        String path = "/storage/emulated/0/internalDisk/截屏/20200520112900.png";
...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    private void getWeChatStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        mPictureParameterStyle.pictureTitleUpResId = R.drawable.dark_picture_icon_wechat_up;
        // 相册列表标题栏右侧下拉箭头
        mPictureParameterStyle.pictureTitleDownResId = R.drawable.dark_picture_icon_wechat_down;
        // 相册文件夹列表选中圆点
        mPictureParameterStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
...
//        mPictureParameterStyle.pictureWeChatPreviewSelectedTextSize = 9;
        ...
        mCropParameterStyle = new PictureCropParameterStyle(
                ...
                ContextCompat.getColor(getContext(), R.color.app_color_white),
                mPictureParameterStyle.isChangeStatusBarFontColor);
        mCropParameterStyle.completeText = "完成";
    }
